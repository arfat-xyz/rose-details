...
const Card = ({ image, heading, desc, btnLink }) => {
  return (
    <>
      <div className=" hover:scale-105 transition duration-500 max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        <Link href={btnLink}>
          <Image
